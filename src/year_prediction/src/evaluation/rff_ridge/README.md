...
for dimension in 256 512 1024; do
  spark-submit --master 'local[2]' --driver-memory 2g \
    ...
    src/year_prediction/src/evaluation/rff_ridge/evaluate.py \
...
Each run writes test artifacts under `parquets/year_prediction/results/model_comparison/rff_ridge/rff-ridge-t90-d<dimension>/test/`.
