...
\begin{textblock}{29.5}(35.25,24.8)
  \begin{discoverycard}[height=22.3cm]
    ...
    \vspace{-1.15cm}
    \begin{center}
      {\fontsize{60}{64}\selectfont\bfseries\color{posterpurple!95!posterink}+13.6\%\par}
      \vspace{.10cm}
      {\fontsize{27}{32}\selectfont\bfseries\color{posterink}MIXED-QUERY nDCG@20\par}
      \vspace{.15cm}
      {\fontsize{21}{26}\selectfont\bfseries\color{postermuted}
        0.0078 $\longrightarrow$ 0.0089 on the confirmation benchmark\par}
    \end{center}

    \vspace{.18cm}
    \begin{center}
      \includegraphics[width=.98\linewidth]{img/merlin_two_stage_poster.pdf}
    \end{center}
    ...
    \begin{columns}[T,onlytextwidth]
      \column{.48\textwidth}
      \centering
      {\fontsize{42}{47}\selectfont\bfseries\color{posterteal}+3.9\%\par}
      \vspace{.10cm}
      {\fontsize{23}{28}\selectfont\bfseries\color{posterink}MACRO nDCG@20\par}
      \vspace{.12cm}
      {\fontsize{20}{25}\selectfont\color{postermuted}0.0095 $\longrightarrow$ 0.0099\par}

      \column{.48\textwidth}
      \centering
      {\fontsize{42}{47}\selectfont\bfseries\color{posterteal}90.1\%\par}
      \vspace{.10cm}
      {\fontsize{23}{28}\selectfont\bfseries\color{posterink}ACOUSTIC BASELINE RETAINED\par}
      \vspace{.12cm}
      {\fontsize{20}{25}\selectfont\color{postermuted}0.0208 $\longrightarrow$ 0.0187\par}
    \end{columns}
