...
\newtcolorbox{graphcard}[1][]{
  evidencecard,
  colframe=posterblue!78!posterink,
  borderline={4.4mm}{0mm}{posterblue!13!white},
  borderline={1.55mm}{0mm}{posterblue!84!posterink},
  borderline={.38mm}{-1.30mm}{white!88!posterblue},
  overlay={
    \draw[posterblue!95!posterink,line width=3.15mm,line cap=round]
      ([xshift=.72cm]frame.north west) -- ([xshift=7.8cm]frame.north west);
    \draw[posterblue!90!posterink,line width=1.34mm,line cap=round]
    ...
    \foreach \x/\y in {4.2/.56,7.4/0,10.3/.56,13.3/0,17.0/0,20.0/0}{
      \fill[posterblue!95!posterink]
        ([xshift=\x cm,yshift=\y cm]frame.south west) circle (.20cm);
    }
    \draw[posterblue!82!posterink,line width=1.15mm]
...
\newtcolorbox{eracard}[1][]{
  evidencecard,
  colframe=postergold!82!posterink,
  borderline={4.4mm}{0mm}{postergold!13!white},
  borderline={1.55mm}{0mm}{postergold!86!posterink},
  borderline={.38mm}{-1.30mm}{white!88!postergold},
  overlay={
    \draw[postergold!95!black,line width=3.15mm,line cap=round]
      ([xshift=.72cm]frame.north west) -- ([xshift=8.4cm]frame.north west);
    \draw[postergold!92!black,line width=1.35mm,line cap=round]
      ([xshift=1.5cm]frame.south west) -- ([xshift=-4.0cm]frame.south east);
    \foreach \f in {.08,.18,.28,.38,.48,.58,.68,.78,.88}{
      \draw[postergold!90!black,line width=1.05mm]
        ($(frame.south west)!\f!(frame.south east)+(0,-.46cm)$)
        -- ($(frame.south west)!\f!(frame.south east)+(0,.46cm)$);
    }
    \draw[postergold!92!black,line width=1.38mm,line cap=round,line join=round]
    ...
    \foreach \dy in {-4.0,-7.2,-10.4,-13.6}{
      \draw[postergold!78!posterink,line width=1.2mm]
...
\newcommand{\graphmark}{%
  \begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \draw[posterblue!86!posterink,line width=1.02mm,line cap=round]
      (g1) -- (g2) -- (g4) -- (g6)
      (g1) -- (g3) -- (g4)
      (g3) -- (g5) -- (g6);
    \foreach \p/\r in {g1/.14,g2/.18,g3/.15,g4/.22,g5/.17,g6/.20}
      \fill[posterblue!94!posterink] (\p) circle (\r cm);
  \end{tikzpicture}%
}
...
\newcommand{\eramark}{%
  \begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \draw[postergold!90!black,line width=1.18mm,line cap=round]
      (22.0,.58) -- (50.8,.58);
    \foreach \x in {23.0,27.0,31.0,35.0,39.0,43.0,47.0,50.0}{
      \draw[postergold!88!black,line width=.86mm]
        (\x,.20) -- (\x,.96);
    }
    ...
    \draw[postergold!92!black,line width=.92mm,line cap=round,line join=round]
