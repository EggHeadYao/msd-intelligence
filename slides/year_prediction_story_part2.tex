\subsection{Diagnosing Model Error}

\begin{frame}{RFF: more smooth nonlinearity, little gain}
...
{\small The gain saturates as $D$ grows; smooth nonlinearity is not the main bottleneck.}
...
\begin{frame}{Why LightGBM fits this bottleneck}
...
\vspace{.35cm}
{\large\bfseries Same T90 evidence; a stronger function family.}
...
\begin{frame}{Same T90, stronger function family}
...
\begin{frame}{From T90 summaries to 594 audio predictors}
...
\vspace{.15cm}{\large\bfseries\color{structbgcolor}Same model family, 0.4451-year RMSE gain}
...
\begin{frame}{Ordinal-MoE: two views of an ordered target}
...
\]
{\scriptsize Each probability asks whether the release year exceeds one ordered threshold.}
\note{
...
\begin{frame}{Ordinal-MoE trades tail risk for typical accuracy}
...
\vspace{.2cm}
{\small Better typical accuracy, but higher tail risk.}
