...
class InferenceArtifactPaths:
    ...
    set_c_protocol: Path = SET_C_PROTOCOL_PATH
    set_c_candidate_pool: Path = SET_C_CANDIDATE_POOL_PATH
    set_c_candidate_pool_manifest: Path = SET_C_CANDIDATE_POOL_MANIFEST_PATH
    set_c_positives: Path = SET_C_POSITIVES_PATH
    set_c_validation_pairs: Path = SET_C_VALIDATION_PAIRS_PATH
    set_c_groups_manifest: Path = SET_C_GROUPS_MANIFEST_PATH
    set_c_raw_features: Path = SET_C_RAW_FEATURES_PATH
    set_c_raw_features_manifest: Path = SET_C_RAW_FEATURES_MANIFEST_PATH
    set_c_evaluation_report: Path = SET_C_EVALUATION_REPORT_PATH
