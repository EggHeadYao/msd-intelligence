...
DEVELOPMENT_EVALUATION_ROOT = RANKER_ROOT / "development_evaluation"
...
DEVELOPMENT_PROTOCOL_PATH = DEVELOPMENT_EVALUATION_ROOT / "protocol.json"
DEVELOPMENT_CANDIDATE_POOL_PATH = DEVELOPMENT_EVALUATION_ROOT / "candidate_pool.parquet"
DEVELOPMENT_CANDIDATE_POOL_MANIFEST_PATH = DEVELOPMENT_EVALUATION_ROOT / "candidate_pool_manifest.json"
DEVELOPMENT_POSITIVES_PATH = DEVELOPMENT_EVALUATION_ROOT / "validation_group_positives.parquet"
DEVELOPMENT_VALIDATION_PAIRS_PATH = DEVELOPMENT_EVALUATION_ROOT / "validation_pairs.parquet"
DEVELOPMENT_GROUPS_MANIFEST_PATH = DEVELOPMENT_EVALUATION_ROOT / "validation_groups_manifest.json"
DEVELOPMENT_RAW_FEATURES_PATH = DEVELOPMENT_EVALUATION_ROOT / "raw_pair_features.parquet"
DEVELOPMENT_RAW_FEATURES_MANIFEST_PATH = DEVELOPMENT_EVALUATION_ROOT / "raw_pair_features_manifest.json"
DEVELOPMENT_EVALUATION_REPORT_PATH = DEVELOPMENT_EVALUATION_ROOT / "evaluation_report.json"
...
class InferenceArtifactPaths:
    ...
    tuning_training_pairs: Path = TUNING_TRAINING_PAIRS_PATH
    tuning_training_pairs_manifest: Path = TUNING_TRAINING_PAIRS_MANIFEST_PATH
    tuning_raw_pair_features: Path = TUNING_RAW_PAIR_FEATURES_PATH
    tuning_raw_pair_features_manifest: Path = TUNING_RAW_PAIR_FEATURES_MANIFEST_PATH
    ...
    development_protocol: Path = DEVELOPMENT_PROTOCOL_PATH
    development_candidate_pool: Path = DEVELOPMENT_CANDIDATE_POOL_PATH
    development_candidate_pool_manifest: Path = DEVELOPMENT_CANDIDATE_POOL_MANIFEST_PATH
    development_positives: Path = DEVELOPMENT_POSITIVES_PATH
    development_validation_pairs: Path = DEVELOPMENT_VALIDATION_PAIRS_PATH
    development_groups_manifest: Path = DEVELOPMENT_GROUPS_MANIFEST_PATH
    development_raw_features: Path = DEVELOPMENT_RAW_FEATURES_PATH
    development_raw_features_manifest: Path = DEVELOPMENT_RAW_FEATURES_MANIFEST_PATH
    development_evaluation_report: Path = DEVELOPMENT_EVALUATION_REPORT_PATH
    no_hard_neg_training_manifest: Path = NO_HARD_NEG_TRAINING_MANIFEST_PATH
    no_hard_neg_schema: Path = NO_HARD_NEG_SCHEMA_PATH
    no_hard_neg_scaler: Path = NO_HARD_NEG_SCALER_PATH
    no_hard_neg_coefficients: Path = NO_HARD_NEG_COEFFICIENTS_PATH
    no_hard_neg_pairs: Path = NO_HARD_NEG_PAIRS_PATH
    no_hard_neg_pairs_manifest: Path = NO_HARD_NEG_PAIRS_MANIFEST_PATH
    no_hard_neg_raw_features: Path = NO_HARD_NEG_RAW_FEATURES_PATH
    no_hard_neg_raw_features_manifest: Path = NO_HARD_NEG_RAW_FEATURES_MANIFEST_PATH
