    ...
    write_json_atomic(
        {
            **common,
            ...
            "fit_split": "set_a",
            "training_universe": (
                "set_a" if stage == "tuning" else "a_b_c_remaining"
            ),
    ...
    write_json_atomic(
        {
            **common,
            ...
            "model_version": "full-merlin-lr-v3",
            ...
            "ranking_policy": "query_gated_audio_lr_quota_interleave",
            "audio_quota": int(audio_quota),
            "relation_gate_threshold": float(relation_gate_threshold),
            "high_evidence_audio_quota": int(high_quota),
            "high_relation_gate_threshold": float(high_threshold),
            "gate_policy": RELATION_GATE_POLICY,
